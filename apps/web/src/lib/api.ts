...
/** Eine Zelle des Preisrasters: der günstigste Törn mit diesem Start und dieser Dauer. */
...
export const getPriceGrid = (params: Query) =>
  apiFetch<PriceGridResult>(`/search/price-grid${toQuery(params)}`);
